...
wilbur_mexicana_gmap = json.load(open("../scrapy-yelp-tripadvisor/tutorial/spiders/data/json/" + restaurants[0] + "_gmaps_" + date + ".json"))
celebrity_hot_pot_gmap = json.load(open("../scrapy-yelp-tripadvisor/tutorial/spiders/data/json/" + restaurants[1] + "_gmaps_" + date + ".json"))
hashi_izakaya_gmap = json.load(open("../scrapy-yelp-tripadvisor/tutorial/spiders/data/json/" + restaurants[2] + "_gmaps_" + date + ".json"))
kinka_izakaya_gmap = json.load(open("../scrapy-yelp-tripadvisor/tutorial/spiders/data/json/" + restaurants[3] + "_gmaps_" + date + ".json"))
sushi_bong_gmap = json.load(open("../scrapy-yelp-tripadvisor/tutorial/spiders/data/json/" + restaurants[4] + "_gmaps_" + date + ".json"))
uncle_tetsu_gmap = json.load(open("../scrapy-yelp-tripadvisor/tutorial/spiders/data/json/" + restaurants[5] + "_gmaps_" + date + ".json"))
