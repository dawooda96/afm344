...
filePaths = ['sentiment_graph_1', 'sentiment_graph_2', 'traffic_wilbur_mexicana', 'traffic_celebrity_hot_pot', 'traffic_hashi_izakaya', 'traffic_kinka_izakaya', 'traffic_sushi_bong', 'traffic_uncle_tetsu']
